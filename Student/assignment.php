...
<pre><h2 class="text-center text-primary">Select Subject to View Assignment</h2></pre>
  ...
  <?php 
    ...
    <tr>
      ...
      <li style="list-style:none;">
            <a  href = "<?php echo '../'.$act_file; ?>" title="open file" >
      ...
      <td> 
         <div class="row"> 
            <div class="col-md-4">
                 <a class="btn btn-info btn-sm" href="submit_activity.php?act_id=<?php echo $act_id; ?>" title="submit" name="upload">
                     <i class="fa fa-subway" aria-hidden="true"></i>   
                  </a> 
            </div>
            <div class="col-md-4">
              <a class="btn btn-success btn-sm" href="update_activity.php?act_id=<?php echo $act_id;?>" title="edit" name="edit">
