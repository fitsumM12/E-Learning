...
<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
    <div class="btn-group mr-2" role="group" aria-label="First group">
        <button type="button" class="btn btn-primary"  onclick="window.open('manage_students.php','_self')">Back</button>
    </div>
</div>
...
<div class = "row">
<div class = "col-sm-6">
    <form action="" method="POST" role="form" id="editstdAprovForm" enctype = "multipart/form-data">
            <legend>The Applicant Details</legend>
    <span>
            <div class="form-group">
            <label for=""></label>
            <input type="text" class="form-control" name="std_id" value='<?php echo $_GET['std_id'];?>' hidden>
        </div>
        <div class="form-group">
            <label for="">Name</label>
            <input type="text" class="form-control" name = "std_name" value="<?php echo $_GET['studname'];?>" readonly>
        </div>
        <div class="form-group">
    ...
    <span>
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary" id="btn_aprove_std">Approve</button>&nbsp;&nbsp;
            <button type="submit" class="btn btn-primary" id="btn_reject_std">Reject</button>
        </div>
        </span>
        </form>
        </div>
